...
const LatestBlogCard = ({ Title }: prop) => {
  return (
    <div className="rounded-xl bg-neutral-300 dark:bg-neutral-900 dark:hover:bg-neutral-800 py-5 px-4 md:px-10 w-full md:w-1/2 pl-4 md:pl-8 my-1 flex flex-col  gap-2 shrink-0">
  ...
  return (
    <div className="relative  w-full  py-10 md:py-13 my-8 md:my-20 flex flex-col lg:flex-row items-center justify-center md:justify-between">
      ...
      <div className="w-full md:w-1/3 flex items-center justify-center ">
        <h2 className="w-full text-[30px] leading-[40px] font-semibold text-center md:text-left mb-4">
